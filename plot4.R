...
par(mfrow=c(2,2))
###topleft
with(a,plot(sTime,Global_active_power,type="l",xlab="",ylab="Gloabl Active Power"))
###topright
with(a,plot(sTime,Voltage,type="l",xlab="datetime",ylab="Voltage"))
###downleft
...
###downright
with(a,plot(sTime,Global_reactive_power,type="l",xlab="datatime",ylab="Gloabl Rective Power"))
dev.off()